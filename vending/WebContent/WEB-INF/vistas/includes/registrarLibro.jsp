       ...
       <h1  style="text-align: center">Registrar producto</h1>
        <div class="form-row col-md-12 col-lg-6 mx-auto">
            <div class="form-group col-md-12">
                ...
                <c:choose>
					<c:when test="${libro_error.errorNombre != null}">
						<input type="text" class="form-control  is-invalid" id="inputEmail4" name="nombre" value="${libro_error.nombre}" >
						 <div class="invalid-feedback">
							${libro_error.errorNombre}
     					 </div>
					</c:when>
						<c:otherwise>
						<input type="text" class="form-control" id="inputEmail4" name="nombre" value="${libro_error.nombre}" >
					</c:otherwise>
				</c:choose>
            </div>
        </div>
